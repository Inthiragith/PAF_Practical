...
//		request.getParameter("appointmentid"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = AppointObj.updateAppointment(
		...
		//String output = appointObj.updateAppointment( appointmentid, doctorid, doctorName, patientid, patientName,
		//		hospitalName, date);
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		Map paras = getParasMap(request);
		String output = AppointObj.deleteAppointment(paras.get("appointmentid").toString());
		response.getWriter().write(output);
	}
